...
sitedata:
    Slc:
        ...
        Dolly_Laster:
            ...
            Wohnort: ""
            Position: ""
        Jean_Damme_van_Raumcloud:
            Name: "Jean Damme van Raumcloud"
            Rasse: "Streifanier"
            Kategorie: "Promi"
            Wohnort: ""
            Position: ""
        ...
        Kuster_Beaton:
            ...
            Wohnort: ""
            Position: ""
        Long_Dong_Plasmatongue:
            Name: "Long Dong Plasmatongue"
            Rasse: "Samnese"
            Kategorie: "Promi"
            Wohnort: ""
            Position: ""
        Melonen-Wagoner_Chaplin:
            Name: "Melonen-Wagoner Chaplin"
            Rasse: "Wagone"
            Kategorie: "Promi"
            Wohnort: ""
            Position: ""
...
{% include slc.md data=page.sitedata.Slc.Alexa_Reed %}
...
{% include slc.md data=page.sitedata.Slc.Barbara_Streifsand %}
...
{% endcapture %}
{% include anmerkung.md title="Britney S. Pears hebt ab" body=include_body %}

{% include slc.md data=page.sitedata.Slc.Britney_S_Pears %}
...
{% include slc.md data=page.sitedata.Slc.Olf_Dundgren %}
...
{% include slc.md data=page.sitedata.Slc.Raul_Reitner %}
...
| Khan Keyne | Kahadrier |
| Kuster Beaton | Mensch |
| Long Dong Plasmatongue | Samnese |
| Melonen-Wagoner Chaplin | Wagone |
...
{% include slc.md data=page.sitedata.Slc.Martinez_Hernandes %}
