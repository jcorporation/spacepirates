tabellen['rsmacken'] = ['Rechts ist Links', 'Schwarzes Bild', 'Unwahrscheinlichkeitswirbel', 'Fasching', 'Antriebswackler', 'Scheibe beschlagen',
	'Spontane Raumzeitkrümmung', 'Tropenwetter', 'KI eingebaut', 'Knopf klemmt', 'Schiff wird rosa', 'Reboot nötig', 'Lack bröckelt', 'Stabilisatoren versagen',
	'Waffenproblem', 'Hanfwachstum', 'Schildfluktuationen', 'Weltraumherpes', 'FTL macht Wupp', 'Computer deprimiert', 'Piepsstimmen', 'Schluckauf des Hyperkerns',
	'Licht aus', 'Papierstau', 'Instrumente blinken', 'Schwerkraft verdoppelt sich', 'Antiquierte Technik', 'Türen zu', 'Sitze unbequem', 'Schwerkraft fällt aus'];

tabellen['scmacken'] = ['technikverliebt', 'zu wagemutig', 'ist immer wesentlich zu früh', 'hat einen Lieblingsspruch den er bei jeder Gelegenheit verwendet',
	'Ökoaktivist', 'erzählt dauernd alte Geschichten', 'immer auf eine Schlägerei aus', 'hasst eine Regierung und rebelliert gegen diese',
	'kann nicht weiter als bis 20 rechnen', 'wirkt auf andere Piraten zu weibisch oder mimosenhaft', 'extreme Stimmungsschwankungen', 'geldgierig',
	'hasst eine Alienrasse', 'trägt die Augenklappe nur weil er dann grimmiger aussieht', 'Religiöser Fanatiker', 'extrem bürokratisch',
	'überzeugter Esoteriker', 'zu cool für dieses Universum', 'rumsüchtig', 'zu redegewandt macht viele Worte und jeder versteht nur die Hälfte',
	'schnell beleidigt', 'bewegt sich in der Öffentlichkeit nur maskiert', 'in seinen Cyberpapagei vernarrt', 'spuckt ständig Kautabak in die Ecke',
	'verträgt keinen Alkohol außer Rum', 'hyperaktiv und nervös', 'immer hinter den Weibern bzw. Kerlen her', 'hoffnungsloser Optimist', 'griesgrämig',
	'extremer Macho oder extreme Feministin'];
